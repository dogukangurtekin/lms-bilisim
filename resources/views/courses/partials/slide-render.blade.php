...
.sqz-opt.is-correct{outline:4px solid #16a34a}
.sqz-opt.is-wrong{outline:4px solid #ef4444}
.sqz-opt.is-locked{cursor:not-allowed;opacity:.85}
.sqz-opt.is-locked:not(.is-correct):not(.is-wrong){opacity:.55}
